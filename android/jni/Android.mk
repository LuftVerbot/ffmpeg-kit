...
MY_SRC_FILES := ffmpegkit.c ffprobekit.c ffmpegkit_exception.c fftools_cmdutils.c fftools_ffmpeg.c fftools_ffprobe.c fftools_ffmpeg_mux.c fftools_ffmpeg_mux_init.c fftools_ffmpeg_demux.c fftools_ffmpeg_opt.c fftools_opt_common.c fftools_ffmpeg_hw.c fftools_ffmpeg_filter.c fftools_ffmpeg_dec.c fftools_ffmpeg_enc.c fftools_ffmpeg_sched.c fftools_sync_queue.c fftools_thread_queue.c graph/graphprint.c resources/resman.c resources/graph_resources.c textformat/avtextformat.c textformat/tf_compact.c textformat/tf_default.c textformat/tf_flat.c textformat/tf_ini.c textformat/tf_json.c textformat/tf_mermaid.c textformat/tf_xml.c textformat/tw_avio.c textformat/tw_buffer.c textformat/tw_stdout.c
